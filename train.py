...
def lejepa_forward(self, batch, stage, cfg):
    ...
    output["vicreg_loss"] = self.vicreg(emb.transpose(0, 1))
    output["loss"] = output["pred_loss"] + lambd * output["vicreg_loss"]  
...
def run(cfg):
    ...
    try:
        ...
        world_model = spt.Module(
            model = world_model,
            vicreg = VICReg(**cfg.loss.vicreg.kwargs),
