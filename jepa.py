...
class JEPA(nn.Module):
    ...
    def criterion(self, info_dict: dict):
        ...
        # Project Euclidean states to Poincaré ball
        pred_emb_proj = poincare_project(pred_emb[..., -1:, :])
        goal_emb_proj = poincare_project(goal_emb[..., -1:, :].detach())

        # return last-step cost per action candidate using poincare distance squared
        dist = poincare_distance(pred_emb_proj, goal_emb_proj)
