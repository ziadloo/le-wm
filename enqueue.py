...
PRESETS = {
    "vit_layernorm_exact_gelu_mlp_up_validation": {
        "project_name":"LeWM/Kernel Validation","task_name":"LeWM-vit-layernorm-exact-gelu-mlp-up-v1-training-validation",
        ...
        "overrides":{"trainer.max_epochs":1,"scheduler_max_epochs":1,"trainer.precision":"bf16-mixed","trainer.limit_train_batches":5,"trainer.limit_val_batches":0,"trainer.log_every_n_steps":1,"loader.batch_size":144,"loader.num_workers":2,"loader.persistent_workers":False,"compile":True,"epoch_interval":1,"model.encoder.mlp_up_implementation":"validate"},
        "tags":["kernel-validation","vit-layernorm-exact-gelu-mlp-up","v1","pusht","bf16-mixed","compile"],"packages":DEFAULT_TRAIN_PACKAGES,
    },
    ...
    "predictor_gated_residual_gemm_validation": {
        ...
        "task_type": Task.TaskTypes.training, "script": "train.py",
        "argparse_args": [("data", "pusht_lance")], "config_path": "config/train/lewm.yaml",
        "data_config_path": "config/train/data/pusht.yaml", "dataset_name": "pusht_expert_train.lance",
        "clearml_dataset_name": "LeWM-PushT",
        "overrides": {"trainer.max_epochs":1,"scheduler_max_epochs":1,"trainer.precision":"bf16-mixed",
          "trainer.limit_train_batches":5,"trainer.limit_val_batches":0,"trainer.log_every_n_steps":1,
          "loader.batch_size":144,"loader.num_workers":2,"loader.persistent_workers":False,"compile":True,
          "epoch_interval":1,"model.predictor.gated_residual_gemm_implementation":"validate"},
        "tags":["kernel-validation","predictor-gated-residual-gemm","v1","pusht","bf16-mixed","compile"],
        "packages":DEFAULT_TRAIN_PACKAGES,
    },
    "predictor_dual_layernorm_adaln_validation": {
        "project_name": "LeWM/Kernel Validation",
        "task_name": "LeWM-predictor-dual-layernorm-adaln-v1-training-validation",
        ...
        "clearml_dataset_name": "LeWM-PushT",
        "overrides": {
            "trainer.max_epochs": 1, "scheduler_max_epochs": 1,
            "trainer.precision": "bf16-mixed", "trainer.limit_train_batches": 5,
            "trainer.limit_val_batches": 0, "trainer.log_every_n_steps": 1,
            "loader.batch_size": 144, "loader.num_workers": 2,
            "loader.persistent_workers": False, "compile": True,
            "epoch_interval": 1,
            "model.predictor.dual_layernorm_adaln_implementation": "validate",
        },
        "tags": ["kernel-validation", "predictor-dual-layernorm-adaln", "v1", "pusht", "bf16-mixed", "compile"],
        "packages": DEFAULT_TRAIN_PACKAGES,
    },
    "sigreg_validation": {
        "project_name": "LeWM/Kernel Validation",
