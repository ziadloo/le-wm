...
PRESETS = {
    "tworoom": {
        ...
        "task_name": "LeWM-Train-tworoom-vicreg-bf16_mixed",
        ...
        "tags": ["baseline", "tworoom", "lance", "bf16-mixed", "vicreg"],
        "packages": DEFAULT_TRAIN_PACKAGES
    },
    "reacher": {
        "project_name": "LeWM/Training",
        "task_name": "LeWM-Train-reacher-vicreg-bf16_mixed",
        "task_type": Task.TaskTypes.training,
        "script": "train.py",
        ...
        "tags": ["baseline", "reacher", "lance", "bf16-mixed", "vicreg"],
        "packages": DEFAULT_TRAIN_PACKAGES
    },
    "cube": {
        "project_name": "LeWM/Training",
        "task_name": "LeWM-Train-cube_single-vicreg-bf16_mixed",
        "task_type": Task.TaskTypes.training,
        "script": "train.py",
        ...
        "tags": ["baseline", "cube_single", "lance", "bf16-mixed", "vicreg"],
        "packages": DEFAULT_TRAIN_PACKAGES
    },
    "pusht": {
        "project_name": "LeWM/Training",
        ...
        "tags": ["baseline", "pusht", "lance", "bf16-mixed", "vicreg"],
        "packages": DEFAULT_TRAIN_PACKAGES
    },
}
